...
*/
function calcularD(base1){
    document.getElementById("ResultadosIn").innerHTML = "";
    document.getElementById("ResultadosIn").innerHTML = "";
    document.getElementById("Resultados2In").innerHTML = "";
    document.getElementById("Resultados3In").innerHTML = "";
    document.getElementById("ImprimirIn").innerHTML = "";
    ...
    filas_col=document.getElementById("filas").value;
    //columnas=document.getElementById("columnas").value;
    //var n_col=1+parseInt(columnas, 10);
    ...
    matrizcuadrada = matrizCuadradaD(matriz, filas_col);
    ...
    document.getElementById("ResultadosIn").innerHTML = HTML;
    ...
    bucle: for(i=0; i<matriz.length; i++){
        ...
        for(j=0; j<matriz[i].length;j++){
            ...
            if(!eliminarFilasD(matriz, filas_col)){
                //console.log("saludos desde el if");
                document.getElementById("Resultados3In").innerHTML = "El determinante es 0--------1";
                determinante=0;
                solucion=1;
            ...
            if(matriz[i][j]==0 && i==j && j!=filas_col){
                ...
                if(!ordenarD(matriz, i, j, filas_col, estado, matrizinversa)){
                ...
                //ordenarD(matriz, i, j, n_col);
                
                pivote=matriz[i][j];
                if(!operacionD(matriz, i, j, filas_col, pivote, estado, matrizinversa)){
                    document.getElementById("Resultados3In").innerHTML = "El determinante es 0----------2";
                    determinante=0;
                    solucion=1;
                ...
                pivote=matriz[i][j];
                if(!operacionD(matriz, i, j, filas_col, pivote, estado, matrizinversa)){
                    document.getElementById("Resultados3In").innerHTML = "El determinante es 0--------3";
                    determinante=0;
                    solucion=1;
        ...
        for(i=matriz.length-1; i>0; i--){
            ...
            for(j=matriz[i].length-1; j>0;j--){
                if(i==j){
                    ...
                    pivote=matriz[i][j];
                    operacionAtrasD(matriz, i, j, filas_col, pivote, matrizinversa);
    ...
    bucle2: for(i=0; i<matrizcuadrada.length; i++){
        ...
        for(j=0; j<matrizcuadrada[i].length;j++){
            ...
            //console.log("invoko al primer eliminar filas");
            if(!eliminarFilasD(matrizcuadrada, filas_col)){
                //console.log("saludos desde el if");
                document.getElementById("Resultados3In").innerHTML = "El determinante es 0--------1";
                determinante2=0;
                solucion=1;
            ...
            if(matrizcuadrada[i][j]==0 && i==j && j!=filas_col){
                ...
                if(!ordenarD(matrizcuadrada, i, j, filas_col, estado)){
                    //document.getElementById("Resultados3").innerHTML = "No tiene solución";
                    //console.log("No tiene solución");
                    document.getElementById("Resultados3In").innerHTML = "El determinante es 0--------1";
                    determinante2=0;
                ...
                //ordenarD(matrizcuadrada, i, j, n_col);
                
                pivote=matrizcuadrada[i][j];
                if(!operacionD(matrizcuadrada, i, j, filas_col, pivote, estado)){
                    document.getElementById("Resultados3In").innerHTML = "El determinante es 0----------2";
                    determinante2=0;
                    solucion=1;
...
function operacionD(matriz, i, j, n_col, pivote, estado, matrizinversa){
    ...
    if(estado==1){
        imprimirD(matriz, mensaje, matrizinversa, true);
    }else if(estado==2){
        imprimirD(matriz, mensaje);
    }
    ...
    if(!eliminarFilasD(matriz, matriz.length)){
...
function ordenarD(matriz, i, j, n_col, estado, matrizinversa){
...
function operacionAtrasD(matriz, i, j, filas_col, pivote, matrizinversa){
    ...
    for(m=i-1; m>=0; m--){
        ...
        imprimirD(matriz, mensaje, matrizinversa, atras);
    }
...
function eliminarFilasD(matriz, filas_col){
...
function imprimirD(matriz, mensaje, matrizinversa, atras){
...
function imprimirResultadosD(matriz, solucion){
    
    //var i, j, k, m;
    
    //var suma = "";
    var imprimirresultadoFinal = document.getElementById('Resultados3In');
    var resultadoFinal;
...
function matrizCuadradaD(matriz, filas_col){
...
function imprimirCuadradaD(matrizcuadrada){
    var i, j;
